...
<div id="myBody">
	...
	<div class="container">
		<h2 class="bodyTitle wow fadeInUp" data-wow-delay="0.8s">Current <span class="myColor">News</span></h2>
		<div class="separator_leftColor wow fadeInUp" data-wow-delay="0.8s"></div>
	</div>
<?php

require("include/ourNews.php");
