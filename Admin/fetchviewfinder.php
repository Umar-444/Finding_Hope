...
if (isset($_POST['viewFinderId'])) {

          $viewId = $_POST['viewFinderId'];
     ...
     $rowFinder = myFetchArray($resultFinder);
         
     

     $output.="<tr><td colspan='11' class='text-center'><strong>Finder Info</strong><td></tr>
          ...
          $output .="  <tr>
                     ...
                     <tr><td colspan='11' class='text-center'><strong>Missing Case</strong><td>
                         
                     </tr>
                              <tr>
                         <td colspan=11 class='text-center'><img width='350px' src='../".$row['MC_ImageLoc']."'><td>
